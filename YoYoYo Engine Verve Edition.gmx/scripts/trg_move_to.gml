///trg_move_to(type/x pos, y pos, speed, [easing], [relative])
//Moves an object to a specific position.
//Arguments:
//1. x pos - x coordinate if absolute movement or x distance if relative.
//2. y pos
//3. speed
//4. [easing] - EASE.NONE (default). Modifies the movement to either speed up, slow down, or both. The duration will still be the same, meaning eased movement will have to move faster than the defined speed.
