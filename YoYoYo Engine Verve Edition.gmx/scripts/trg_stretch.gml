///trg_stretch(type/x scale, y scale, [time], [easing])
//Smoothly changes an objects scale when triggered.
//Arguments:
//1. x scale
//2. y scale
//3. [time] - duration of the stretch in frames. 20 by default.
//4, [easing] - EASE.NONE (default). Modifies the stretching to either speed up, slow down, or both.
